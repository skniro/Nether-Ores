...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<Feature> context) {
        ...
        List<BlockReplacement> netherCoalOres =
                List.of(BlockReplacement.replace(netherstoneReplaceables, NetherOresBlocks.Nether_Coal_Ore.defaultBlockState()));
        List<BlockReplacement> netherCopperOres =
                List.of(BlockReplacement.replace(netherstoneReplaceables, NetherOresBlocks.Nether_Copper_Ore.defaultBlockState()));
        List<BlockReplacement> netherDiamondOres =
                List.of(BlockReplacement.replace(netherstoneReplaceables, NetherOresBlocks.Nether_Diamond_Ore.defaultBlockState()));
        List<BlockReplacement> netherEmeraldOres =
                List.of(BlockReplacement.replace(netherstoneReplaceables, NetherOresBlocks.Nether_Emerald_Ore.defaultBlockState()));
        List<BlockReplacement> netherGoldOres =
                List.of(BlockReplacement.replace(netherstoneReplaceables, NetherOresBlocks.Nether_Gold_Ore.defaultBlockState()));
        List<BlockReplacement> netherIronOres =
                List.of(BlockReplacement.replace(netherstoneReplaceables, NetherOresBlocks.Nether_Iron_Ore.defaultBlockState()));
        List<BlockReplacement> netherLapisOres =
                List.of(BlockReplacement.replace(netherstoneReplaceables, NetherOresBlocks.Nether_Lapis_Ore.defaultBlockState()));
        List<BlockReplacement> netherRedstoneOres =
                List.of(BlockReplacement.replace(netherstoneReplaceables, NetherOresBlocks.Nether_Redstone_Ore.defaultBlockState()));
        ...
        List<BlockReplacement> endCoalOres =
                List.of(BlockReplacement.replace(endStoneReplaceables, NetherOresBlocks.End_Coal_Ore.defaultBlockState()));
        List<BlockReplacement> endCopperOres =
                List.of(BlockReplacement.replace(endStoneReplaceables, NetherOresBlocks.End_Copper_Ore.defaultBlockState()));
        List<BlockReplacement> endDiamondOres =
                List.of(BlockReplacement.replace(endStoneReplaceables, NetherOresBlocks.End_Diamond_Ore.defaultBlockState()));
        List<BlockReplacement> endEmeraldOres =
                List.of(BlockReplacement.replace(endStoneReplaceables, NetherOresBlocks.End_Emerald_Ore.defaultBlockState()));
        List<BlockReplacement> endGoldOres =
                List.of(BlockReplacement.replace(endStoneReplaceables, NetherOresBlocks.End_Gold_Ore.defaultBlockState()));
        List<BlockReplacement> endIronOres =
                List.of(BlockReplacement.replace(endStoneReplaceables, NetherOresBlocks.End_Iron_Ore.defaultBlockState()));
        List<BlockReplacement> endLapisOres =
                List.of(BlockReplacement.replace(endStoneReplaceables, NetherOresBlocks.End_Lapis_Ore.defaultBlockState()));
        List<BlockReplacement> endRedstoneOres =
                List.of(BlockReplacement.replace(endStoneReplaceables, NetherOresBlocks.End_Redstone_Ore.defaultBlockState()));
